...
import homeImage from "../assets/images/backgrounds/home-image.png";
          ...
          <div className="row">
            <div className="col-lg-10 mx-auto text-center">
              <h2 className="section-title display-4">
                Robert Downey Jr. Highlights
              </h2>
              <h3 className="lead py-3">
                Discover some of the most remarkable achievements and moments
                from Robert Downey Jr.'s illustrious career:
              </h3>
            ...
            <div className="col-lg-4 mb-4 mb-lg-0">
              <div className="card hover-bg-secondary shadow py-4">
                <div className="card-body text-center">
                  ...
                  <p>
                    After overcoming personal struggles, Robert Downey Jr. made
                    a spectacular comeback with his iconic role as Tony Stark in
            ...
            <div className="col-lg-4 mb-4 mb-lg-0">
              <div className="card hover-bg-secondary shadow py-4">
                <div className="card-body text-center">
                  ...
                  <p>
                    As of 2024, Robert Downey Jr. is one of the highest-grossing
                    actors of all time, with his films collectively earning over
            ...
            <div className="col-lg-4 mb-4 mb-lg-0">
              <div className="card hover-bg-secondary shadow py-4">
                <div className="card-body text-center">
                  ...
                  <p>
                    Outside of acting, Robert Downey Jr. is known for his
                    philanthropic efforts, supporting various causes including
                    environmental conservation and children's charities.
                  </p>
                </div>
              </div>
            </div>
